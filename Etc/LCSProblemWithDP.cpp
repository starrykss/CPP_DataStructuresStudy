/* ===========================================================================
 * Title : 최장 공통 부분 시퀀스(LCS, Longest Common Subsequence) 문제 풀기
 * Author : starrykss
 * Date : 2021.07.20
...
int LCS_BruteForce(string A, string B, int i, int j, vector<pair<int, int>> subsequence) {
    ...
    옵션 1) (i + 1)번째와 j번째 문자에 대해 검사를 진행함.
    옵션 2) i번째와 (j + 1)번째 문자에 대해 검사를 진행함.

    이 상태의 LCS는 옵션 1 및 옵션 2의 최댓값과 같음.
    */
